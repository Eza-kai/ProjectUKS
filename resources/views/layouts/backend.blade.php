...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="{{asset('assets/backend/images/logo.svg')}}" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="{{asset('assets/backend/images/logo-mini.svg')}}" alt="logo" /></a>
        </div>
        <ul class="nav">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="index.html"><img src="{{asset('assets/backend/images/logo-mini.svg')}}" alt="logo" /></a>
                ...
                <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('assets/backend/images/faces/face4.jpg')}}" alt="" class="profile-pic" />
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('assets/backend/images/faces/face3.jpg')}}" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('assets/backend/images/faces/face2.jpg')}}" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="{{asset('assets/backend/images/faces/face1.jpg')}}" />
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{asset('assets/backend/images/faces/face10.jpg')}}" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{asset('assets/backend/images/faces/face11.jpg')}}" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{asset('assets/backend/images/faces/face13.jpg')}}" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{asset('assets/backend/images/faces/face16.jpg')}}" alt="image" />
                                <div class="table-user-name ml-3">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{asset('assets/backend/images/dashboard/img_3.jpg')}}" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{asset('assets/backend/images/dashboard/img_1.jpg')}}" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{asset('assets/backend/images/dashboard/img_2.jpg')}}" alt="" />
                      <div class="pt-2">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="{{asset('assets/backend/images/faces/face22.jpg')}}" alt="" />
                          </div>
                      ...
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="{{asset('assets/backend/images/faces/face25.jpg')}}" alt="" />
                          </div>
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="{{asset('assets/backend/images/faces/face15.jpg')}}" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="{{asset('assets/backend/images/faces/face5.jpg')}}" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="{{asset('assets/backend/images/faces/face2.jpg')}}" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="{{asset('assets/backend/images/dashboard/img_4.jpg')}}" alt="" />
                          <div class="pl-2">
                    ...
                    <div class="row py-3 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="{{asset('assets/backend/images/dashboard/img_5.jpg')}}" alt="" />
                          <div class="pl-2">
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="{{asset('assets/backend/images/faces/face1.jpg')}}" alt="" />
                              <img class="ml-1" src="{{asset('assets/backend/images/faces/face10.jpg')}}" alt="" />
                              <img class="ml-1" src="{{asset('assets/backend/images/faces/face14.jpg')}}" alt="" />
                            </span>
                          </span>
                        </p>
                      </li>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="{{asset('assets/backend/images/faces/face2.jpg')}}" alt="" />
                            </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="{{asset('assets/backend/images/faces/face3.jpg')}}" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="{{asset('assets/backend/images/faces/face11.jpg')}}" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="{{asset('assets/backend/images/browser-logo/opera-logo.png')}}" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="{{asset('assets/backend/images/browser-logo/safari-logo.png')}}" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="{{asset('assets/backend/images/browser-logo/chrome-logo.png')}}" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="{{asset('assets/backend/images/browser-logo/firefox-logo.png')}}" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="mr-2" src="{{asset('assets/backend/images/browser-logo/explorer-logo.png')}}" alt="" />
    ...
    <script src="{{asset('assets/backend/vendors/flot/jquery.flot.categories.js')}}"></script>
    <script src="{{asset('assets/backend/vendors/flot/jquery.flot.fillbetween.js')}}"></script>
